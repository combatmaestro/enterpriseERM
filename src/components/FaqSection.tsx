...
const faqs = [
  {
    ...
    answer: "Our free trial gives you full access to all Enterprise.AI features for 14 days. No credit card required. At the end of the trial, you can choose a plan that suits your needs or cancel without any charges."
  },
  {
      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-400">
            Find answers to common questions about Enterprise.AI. If you can't find what you're looking for, feel free to contact our support team.
          </p>
        </div>
