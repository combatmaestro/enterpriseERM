        ...
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            <span className="inline-block bg-saas-orange/10 text-saas-orange px-4 py-2 rounded-full text-sm font-medium mb-6 border border-saas-orange/20">
              Introducing Enterprise.AI 2.0
            </span>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Welcome to Enterprise.AI <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Enterprise Risk Management Simplified</span>
            </h1>
            
            <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
              Consolidate financial, operational, compliance, cybersecurity,
                  and strategic risks into a single, accessible platform.
            </p>
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              ...
              <p className="text-sm text-gray-300">
                <span className="font-semibold text-saas-orange">10+</span> businesses already using our platform
              </p>
            </div>
          </div>
